...
> * 支持i.MXRT全系列MCU，包含i.MXRT105x、i.MXRT102x、i.MXRT106x  
...
![nxpSecBoot_mainWin_marked](http://i2.bvimg.com/670279/c31a571884ab8182.png)
...
![nxpSecBoot_flexspiNorCfgWin_marked](http://i2.bvimg.com/670279/b302ba13b565afe1.png)
...
![nxpSecBoot_usb-hid_detected](http://i1.bvimg.com/670279/64a8d3177d2895cb.png)
...
![nxpSecBoot_connected_to_device](http://i1.bvimg.com/670279/d2adabbf79ef9054.png)
...
![nxpSecBoot_secboot0_intro](http://i1.bvimg.com/670279/a2f576a87f53d802.png)
...
> * 【eFuse Operation Utility】：eFuse烧录窗口，用户可烧录自定义值进Fuse Region。  
> * 【Boot Device Memory】：image回读与标注窗口，用于从Boot Device回读已下载的Bootable image数据，并对数据组成各部分进行标注  
> * 【Secure Boot Type】：安全模式选择，选择想要安全模式（不使能安全，HAB单签名，HAB签名加密，BEE加密）。  
...
![nxpSecBoot_secboot1_unsigned](http://i1.bvimg.com/670279/efd20119938ea3e7.png)
...
![nxpSecBoot_secboot2_signed](http://i1.bvimg.com/670279/9b7cf82111578180.png)
...
![nxpSecBoot_secboot3_hab_encrypted](http://i1.bvimg.com/670279/8af3fa243981a5ff.png)
...
##### 2.3.4 模式四：启用单引擎BEE加密（唯一SNVS Key）
...
![nxpSecBoot_secboot4_bee_encrypted_fixed_key](http://i2.bvimg.com/670279/0394b7b9ace617eb.png)
...
![nxpSecBoot_secboot5_bee_encrypted_flexible_key](http://i1.bvimg.com/670279/5fe69f5b112d3e34.png)
...
![nxpSecBoot_flexibleUserKeysWin](http://i1.bvimg.com/670279/d9c2a086f927d343.png)
...
![nxpSecBoot_secboot6_signed_bee_encrypted](http://i1.bvimg.com/670279/f88a276040163bc0.png)
...
![nxpSecBoot_tool_run_mode](http://i1.bvimg.com/670279/271e2830fa0d9615.png)

#### 3.1 玩转Fuse操作
　　进入Master模式下，可以看到Fuse全部区域都开放了，你可以任意烧写指定的Fuse区域。Fuse操作是按bit一次性的（类似熔丝烧断），只能将0烧写成1，烧录成1之后便无法更改，所以Fuse的操作需要特别谨慎。  

![nxpSecBoot_fuse_under_master_mode](http://i1.bvimg.com/670279/bc5a182eb4bb37bd.png)

　　在上一章节安全加密启动过程中，我们会烧录SRKH(0x580 - 0x5f0)、SW_GP2(0x690 - 0x6c0)、GP4(0x8c0 - 0x8f0)，这些区域一经烧录便不得更改，甚至我们希望这些区域不仅不能被更改，也要不能被回读。  

![nxpSecBoot_fuse_locker](http://i1.bvimg.com/670279/65e512e03e8008bd.png)

　　从上图可知Fuse 0x400即是各Fuse功能区域的Locker，我们可以通过烧录Fuse 0x400来锁住SRKH, SW_GP2, GP4区域。那么如何烧录呢？其实非常简单，直接在各Fuse框内填写想要烧录的值，点击【Burn】按钮即可。  