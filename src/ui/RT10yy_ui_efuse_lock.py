...
class secBootUiEfuseLock(efuseWin_Lock.efuseWin_Lock):
    ...
    def _recoverLastSettings ( self ):
        ...
        self.m_staticText_bit1_0.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        self.m_choice_bit3_2.SetSelection((self.efuseDict['0x400_lock'] & 0x0000000c) >> 2)
        self.m_staticText_bit3_2.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        self.m_choice_bit5_4.SetSelection((self.efuseDict['0x400_lock'] & 0x00000030) >> 4)
        self.m_staticText_bit5_4.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        ...
        self.m_staticText_bit9_8.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        self.m_choice_bit11_10.SetSelection((self.efuseDict['0x400_lock'] & 0x00000c00) >> 10)
        self.m_staticText_bit11_10.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        ...
        self.m_staticText_bit19_18.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        ...
        self.m_staticText_bit22.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        self.m_choice_bit23.SetSelection((self.efuseDict['0x400_lock'] & 0x00800000) >> 23)
        self.m_staticText_bit23.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        ...
        if bit25_24Str[0] != 'x':
            ...
            self.m_staticText_bit25_24.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        else:
            self.m_choice_bit25_24.Enable( False )
        self.m_choice_bit27_26.SetSelection((self.efuseDict['0x400_lock'] & 0x0c000000) >> 26)
        self.m_staticText_bit27_26.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
