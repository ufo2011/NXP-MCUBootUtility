...
from win import efuseWin_MiscConf1_FlexspiNor

class secBootUiEfuseMiscConf1FlexspiNor(efuseWin_MiscConf1_FlexspiNor.efuseWin_MiscConf1_FlexspiNor):

    def __init__(self, parent):
        efuseWin_MiscConf1_FlexspiNor.efuseWin_MiscConf1_FlexspiNor.__init__(self, parent)
    ...
    def _recoverLastSettings ( self ):
        ...
        if bit3_1Str[0] != 'x':
            ...
            self.m_staticText_bit3_1.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        else:
        ...
        if bit15_12Str[0] != 'x':
            ...
            self.m_staticText_bit15_12.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        else:
        ...
        if bit23_16Label != 'Reserved':
            ...
            self.m_staticText_bit23_16.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        else:
        ...
        if bit31_24Label != 'Reserved':
            ...
            self.m_staticText_bit31_24.SetBackgroundColour(uidef_efuse.kEfuseFieldColor_Valid)
        else:
