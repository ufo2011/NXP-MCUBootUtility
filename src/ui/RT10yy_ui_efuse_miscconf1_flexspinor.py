...
class secBootUiEfuseMiscConf1FlexspiNor(RT10yy_efuseWin_MiscConf1_FlexspiNor.efuseWin_MiscConf1_FlexspiNor):
    ...
    def _recoverLastSettings ( self ):
        ...
        if bit3_1Str[0] != 'x':
            ...
            self.m_staticText_bit3_1.SetBackgroundColour(RT10yy_uidef_efuse.kEfuseFieldColor_Valid)
        else:
        ...
        if bit15_12Str[0] != 'x':
            ...
            self.m_staticText_bit15_12.SetBackgroundColour(RT10yy_uidef_efuse.kEfuseFieldColor_Valid)
        else:
        ...
        if bit23_16Label != 'Reserved':
            ...
            self.m_staticText_bit23_16.SetBackgroundColour(RT10yy_uidef_efuse.kEfuseFieldColor_Valid)
        else:
        ...
        if bit31_24Label != 'Reserved':
            ...
            self.m_staticText_bit31_24.SetBackgroundColour(RT10yy_uidef_efuse.kEfuseFieldColor_Valid)
        else:
