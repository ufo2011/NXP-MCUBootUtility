...
class secBootUiEfuseBootCfg2(efuseWin_BootCfg2.efuseWin_BootCfg2):
    ...
    def _recoverLastSettings ( self ):
        ...
        if bit0Str[0] != 'x':
            self.m_choice_bit0.Enable( True )
        ...
        if bit3Str[0] != 'x':
            self.m_choice_bit3.Enable( True )
        ...
        if bit5Str[0] != 'x':
            self.m_choice_bit5.Enable( True )
        ...
        if bit6Str[0] != 'x':
            self.m_choice_bit6.Enable( True )
        ...
        if bit8Str[0] != 'x':
            self.m_choice_bit8.Enable( True )
        ...
        if bit9Str[0] != 'x':
            self.m_choice_bit9.Enable( True )
        ...
        if bit11Str[0] != 'x':
            self.m_choice_bit11.Enable( True )
        ...
        if bit12Str[0] != 'x':
            self.m_choice_bit12.Enable( True )
        ...
        if bit13Str[0] != 'x':
            self.m_choice_bit13.Enable( True )
        ...
        if bit15Str[0] != 'x':
            self.m_choice_bit15.Enable( True )
        ...
        if bit30_24Label != 'Reserved':
            self.m_textCtrl_bit30_24.Enable( True )
