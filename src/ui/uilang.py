...
kMsgLanguageContentDict = {
        ...
        'detectError_hidNotFound0':           ['Cannnot find USB-HID device ',
                                              u"找不到USB-HID设备 "],
        'detectError_hidNotFound1':           ['Please connect USB cable to your board first!',
                                              u"请先将USB线连接到板子!"],
        ...
        'operImgError_hasnotProgImage':       ['You should program your image first!',
                                              u"请首先下载image文件！"],
        'commMemError_failToRead':            ['Failed to read boot device, error code is ',
                                              u"读取启动设备失败，错误的代码是 "],
        'commMemError_failToErase':           ['Failed to erase boot device, error code is ',
                                              u"擦除启动设备失败，错误的代码是 "],
        'commMemError_nonAlignedStart0':      ['Start Address should be aligned with 0x',
                                              u"起始地址应该以 0x"],
        'commMemError_nonAlignedStart1':      [' !',
                                              u"对齐！"],
        'commMemError_failToWrite0':          ['Failed to write boot device, error code is ',
                                              u"写入启动设备失败，错误的代码是 "],
        'commMemError_failToWrite1':          [', You may forget to erase boot device first!',
                                              u"，请确认是否先擦除了启动设备！"],
