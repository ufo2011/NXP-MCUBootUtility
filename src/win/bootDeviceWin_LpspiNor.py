...
class bootDeviceWin_LpspiNor ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 538,246 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
